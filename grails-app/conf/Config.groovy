...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'oauthapp.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'oauthapp.UserRole'
grails.plugin.springsecurity.authority.className = 'oauthapp.Role'
...
grails.plugin.springsecurity.oauth.domainClass = 'oauthapp.OAuthID'
